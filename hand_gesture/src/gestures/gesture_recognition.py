...
class GestureRecognition:
    ...
    def load_model(self):
        ...
        # Read labels ###########################################################
        with open('/home/diabolokiat/hand-gesture-recognition-using-mediapipe/hand_gesture/src/model/keypoint_classifier/keypoint_classifier_label.csv', encoding='utf-8-sig') as f:
